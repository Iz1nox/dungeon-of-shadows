...
const FloorThemes = {
  themes:[
    ...
    {name:'Otchłań',floors:[],minFloor:11,wallHue:265,wallSat:22,floorHue:275,floorSat:12,ambientR:25,ambientG:5,ambientB:45,fog:true,particles:'shadow',ambientFreq:28,ambientVol:.07},
  ],
